// DATE ARCHIVED: 09/16/2020 9:19 AM
// REASON: VERSION 1.0.0
// WORKING: YES
...
- Type 0/1: 0.6s transition
- Type 2: 0.3s transition
*/
...
"scrollType": 2,                // 0-static scroll | 1-overlapping scroll | 2-fade
...
function createPages() {
    ...
    if (carousel.scrollType === 2) {
        carousel.style.innerHTML = ".carousel-transition { transition: left "+carousel.transition+"s, opacity "+carousel.transition+"s, background-position "+carousel.transition+"s; }";
    } else {
