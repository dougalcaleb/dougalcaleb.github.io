...
- This program version requires functions.js v1.1.6 minimum
...
"pages": ["images/carousel/projects/todoapp.png","images/carousel/projects/bubbles.png","images/carousel/projects/2dgame.png","images/carousel/projects/bidapp.png","images/carousel/projects/lander.png","images/carousel/projects/carousel.png"],
...
function carousel_setupVariables() {
    ...
    // substitute mobile variables for normal

    if (screen.width <= carouselMobile.breakpoint) {
        var c = Object.entries(carousel);
        var cm = Object.entries(carouselMobile);
        for (let a = 1; a < obj_length(carouselMobile); a++) {
            for (let b = 0; b < obj_length(carousel); b++) {
                if (c[b][0] == cm[a][0]) {
                    carousel[""+c[b][0]] = cm[a][1];
                }
            }
        }
    }
...
function carousel_setupStructure() {
    ...
    if (carousel.defaultStyle) {
        ...
        carousel.style3.innerHTML = ".carousel-wrap {height: 700px; width: 1250px; position: absolute; margin: auto; right: 0; left: 0; top: 20px;} .carousel-nav {height: 50px; width: 400px; position: absolute; bottom: 0; margin: auto; left: 0; right: 0; z-index: 10;} .carousel-btnL {height: 50px; width: 50px; left: 0; position: absolute;} .carousel-btnR {height: 50px; width: 50px; right: 0; position: absolute;} .carousel-bubbles {position: absolute; margin: auto; left: 0; right: 0; bottom: 0; top: 0; width: 300px; display: flex; justify-content: space-around;} .carousel-btn svg {filter: invert(100%); cursor: pointer; height: 30px; width: 30px; margin: auto; top: 0; bottom: 0; position: absolute;} .carousel-bubble {height: 8px; width: 8px; align-self: center; border-radius: 100%; border: 2px solid white; display: inline-block; transition: 0.2s; cursor: pointer;} .carousel-active-bubble {background: white;} .carousel-inactive-bubble {background: transparent;} .carousel-svg-l {right: 0;} .carousel-svg-r {left: 0;}";
