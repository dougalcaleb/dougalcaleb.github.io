...
class Controls {
   ...
   buttonListeners() {
      ...
      document.querySelector(".snap-0").addEventListener("click", () => { this.settings.rot = 270; Canvas.updateSettings(this.settings, false)});
      document.querySelector(".snap-1").addEventListener("click", () => { this.settings.rot = 90; Canvas.updateSettings(this.settings, false)});
      document.querySelector(".snap-2").addEventListener("click", () => { this.settings.rot = 180; Canvas.updateSettings(this.settings, false)});
      document.querySelector(".snap-3").addEventListener("click", () => { this.settings.rot = 0; Canvas.updateSettings(this.settings, false)});
      document.querySelector(".snap-4").addEventListener("click", () => { this.settings.rot = Canvas.radToDeg(-1 * Canvas.idealAngle); Canvas.updateSettings(this.settings, false)});
      document.querySelector(".snap-5").addEventListener("click", () => { this.settings.rot = Canvas.radToDeg(Math.PI - Canvas.idealAngle); Canvas.updateSettings(this.settings, false)});
      document.querySelector(".snap-6").addEventListener("click", () => { this.settings.rot = Canvas.radToDeg(-1 * (Math.PI - Canvas.idealAngle)); Canvas.updateSettings(this.settings, false)});
      document.querySelector(".snap-7").addEventListener("click", () => { this.settings.rot = Canvas.radToDeg(Canvas.idealAngle); Canvas.updateSettings(this.settings, false)});
   ...
   drawGradient() {
      let gradient;
		if (this.settings.mode == "linear") {
			...
			// Center-to-corner length
			let r = Math.hypot(centerX, centerY);
