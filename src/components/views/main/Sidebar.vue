<template>
	<div>
		<div 
			:class="['h-full bg-gray-1 w-0 sm:w-20 flex flex-col items-center justify-between hover:w-48 transition-all duration-200 z-40 fixed overflow-hidden', {'w-48': hovering}]"
		...
		>
			...
			<div class="grid transition-all duration-200" :style="sidebarIconStyle">
				<div class="contents cursor-pointer text-white hover:text-purple-5">
		...
		<div class="h-10 sm:h-0 bg-gray-0 w-full z-40 fixed bottom-0 flex justify-between items-center text-white px-6 overflow-hidden">
